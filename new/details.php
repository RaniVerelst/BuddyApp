        ...
        <div class="col-sm-12">
            <div class="details">
                ...
                <div class="input_signup">
                    ...
                    <div class="input_signup dropdown">
                        <select class="form-control input-md" name="movie">
                ...
                <!-- submit button -->
                <input class="submit_signup" type="submit" name="submit" value="Vervoledig profiel">
                <!--- skip process -->
                <input class="submit_signup" type="submit" name="skip" value="Andere keer">
                </form>
            </div>
        </div>
    </div>
